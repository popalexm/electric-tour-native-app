...
public class GetFollowingWaypointsFromOrigin extends BaseUseCase implements BaseUseCaseSingle {

    @NonNull
    private final LocalStorageManager storageManager;
    private final int checkpointId;

    public GetFollowingWaypointsFromOrigin(@NonNull Scheduler executorThread, @NonNull Scheduler postExecutionThread,
