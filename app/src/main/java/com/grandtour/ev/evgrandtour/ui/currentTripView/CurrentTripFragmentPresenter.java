...
public class CurrentTripFragmentPresenter extends BasePresenter
        implements CurrentTripFragmentContract.Presenter, ServiceConnection, OnSuccessListener<Location>, ChartDataCreatedListener {

    @NonNull
    private final String TAG = CurrentTripFragmentPresenter.class.getSimpleName();
    private final int NAVIGATION_CHECKPOINTS_SIZE = 11;

    @NonNull
    private final ServiceConnection serviceConnection = this;
    @NonNull
    private final CurrentTripFragmentContract.View view;
    @Nullable
    ...
    CurrentTripFragmentPresenter(@NonNull CurrentTripFragmentContract.View view) {
        this.view = view;
    }
